...
namespace AudioVolume.Models
{
    public class ConfigSite
    {
        ...
        [Display(Name = "Miễn cước"), StringLength(50, ErrorMessage = "Tối đa 50 ký tự"), UIHint("TextBox")]
        public string Hotline { get; set; }
        [Display(Name = "Miền Nam"), StringLength(50, ErrorMessage = "Tối đa 50 ký tự"), UIHint("TextBox")]
        public string Hotline2 { get; set; }
        [Display(Name = "Miền Bắc"), StringLength(50, ErrorMessage = "Tối đa 50 ký tự"), UIHint("TextBox")]
